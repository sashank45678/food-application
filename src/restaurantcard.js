...
const Restaurantcard = ({ element }) => {
  ...
  return (
    <div data-testid="rescard" className="m-4 p-4 w-[275px] rounded-lg bg-gray-100 hover:bg-gray-400">
  ...
  return (props) => {
    return (
      <div className="relative">
        <label className=" absolute top-0.5 right-1.5 p-1 m-1 bg-slate-600 text-white rounded-lg">Promoted</label>
